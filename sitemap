...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      ...
      var tocNote = '<span class="toc-note">Total number of topics: ' + numDisplayed + ' Department specific \'';
      tocNote += postFilter + '\' *** '+ postTitle.length + ' Total number of topics<br/></span>';
   }
